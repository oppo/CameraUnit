 ...
 *
 * File: - BaseFeatureExposureCompensation.java
 * Description:
 *     N/A
 *
 * Version: 1.0.0
...
public abstract class BaseFeatureExposureCompensation implements IFeature {
    @Override
    public String getFeatureName(Context appContext) {
        return appContext.getString(R.string.config_name_exposure);
    }
