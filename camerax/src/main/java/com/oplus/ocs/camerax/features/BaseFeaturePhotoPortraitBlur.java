 ...
 *
 * File: - BaseFeaturePhotoPortraitBlur.java
 * Description:
 *     N/A
 *
 * Version: 1.0.0
...
public abstract class BaseFeaturePhotoPortraitBlur implements IFeature {
    @Override
    public String getFeatureName(Context appContext) {
        return appContext.getString(R.string.config_name_blur);
    }

    @Override
    public int getFeatureIconId() {
        return R.drawable.menu_blur_on;
    }
